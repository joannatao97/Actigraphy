...
do
	...
	echo '<div class="reportItem"><div class="reportItemDescription">' > ${sub}.accel.html${html_n}
	echo '<span class="reportItemDescriptionHeader">' >> ${sub}.accel.html${html_n}
	echo 'Accelerometer (phone)' >> ${sub}.accel.html${html_n}
	echo '</span><span class="reportItemDescriptionDetail">'${n}'/'${hours}' hours collected ('${pct}')</span></div>' >> ${sub}.accel.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${pngmean}'" alt="accelm" /></div>' >> ${sub}.accel.html${html_n}
    echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${png}'" alt="accel"/>' >> ${sub}.accel.html${html_n} 
    echo '<img class="reportItemLegendImage"src="PNG/CBARS/accel_bar.png" alt="accel_legend" /></div>' >> ${sub}.accel.html${html_n}
    echo '</div>' >> ${sub}.accel.html${html_n}
