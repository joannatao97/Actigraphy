...
do
	...
	/ncf/nrg/sw/apps/matlab/R2012b/bin/matlab -nosplash -nodisplay -nodesktop -nojvm -r "addpath('${dp_home}/commons'); beiwe_audio_env('$wav');quit()" >/dev/null 2>/dev/null
...
do
	...
	echo '<div class="reportItem"><div class="reportItemDescription">' > ${sub}.voiceRecording.html${html_n}
	echo '<span class="reportItemDescriptionHeader">' >> ${sub}.voiceRecording.html${html_n}
	echo 'Voice Recordings' >> ${sub}.voiceRecording.html${html_n}
	echo '</span><span class="reportItemDescriptionDetail">'${n}'/'${days}' days collected ('${pct}')</span></div>' >> ${sub}.voiceRecording.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${pngmean}'" alt="voicem" /></div>' >> ${sub}.voiceRecording.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${png}'" alt="voice" /><img class="reportItemLegendImage" src="PNG/CBARS/voice_bar.png" alt="voice_bar_legend" /></div>' >> ${sub}.voiceRecording.html${html_n}
	echo '</div>' >> ${sub}.voiceRecording.html${html_n}
