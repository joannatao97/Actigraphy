...
do
	...
	then
		...
		mkdir ${subID} ${subID}/{phone,mri,actigraphy,info,dp_report,safire} ${subID}/actigraphy/{raw,processed} ${subID}/phone/processed ${subID}/phone/processed/${bwID} ${subID}/mri/{struc,func,qc,processed,clin} ${subID}/mri/processed/{fs450,fs531}
