...
do
	...
	echo '<div class="reportItem"><div class="reportItemDescription">' > ${sub}.textsLog.html${html_n}
	echo '<span class="reportItemDescriptionHeader">' >> ${sub}.textsLog.html${html_n}
	echo 'Text Logs' >> ${sub}.textsLog.html${html_n}
	echo '</span><span class="reportItemDescriptionDetail">'${n}'/'${hours}' hours collected ('${pct}')</span></div>' >> ${sub}.textsLog.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${pngmean}'" alt="textm" /></div>' >> ${sub}.textsLog.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${png}'" alt="text" /><img class="reportItemLegendImage" src="PNG/CBARS/textsLog_bar.png" alt="textsLog_bar_legend" /></div>' >> ${sub}.textsLog.html${html_n}
	echo '</div>' >> ${sub}.textsLog.html${html_n}
