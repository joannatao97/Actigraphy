...
do
	...
	echo '<div class="reportItem"><div class="reportItemDescription">' > ${sub}.gps.html${html_n}
	echo '<span class="reportItemDescriptionHeader">' >> ${sub}.gps.html${html_n}
	echo 'Distance from Home (phone)' >> ${sub}.gps.html${html_n}
	echo '</span><span class="reportItemDescriptionDetail">'${n}'/'${hours}' hours collected ('${pct}')</span></div>' >> ${sub}.gps.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${pngmean}'" alt="gpsm" /></div>' >> ${sub}.gps.html${html_n}
	echo '<div class="reportItemImage"><img class="reportItemDataImage" src="'${png}'" alt="gps" /><img class="reportItemLegendImage" src="PNG/CBARS/gps_disthome_bar.png" alt="gps_disthome_bar_legend" /></div>' >> ${sub}.gps.html${html_n}
	echo '</div>' >> ${sub}.gps.html${html_n}
