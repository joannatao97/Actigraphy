...
if [ ${study} == "BLS" ]
then
	/ncf/cnl/13/users/jbaker/PSF_SCRIPTS/CRONS/redcap_bls_demos.sh | sed 's/"//g' | sed 's/SZA Bipolar [t,T]ype/SZA-BP/g' | awk -F , '{OFS=","; if ($4=="0") $4="MALE"; if ($4=="1") $4="FEMALE"; if ($5=="1") $5="White"; if ($5=="2") $5="Asian"; if ($5=="4") $5="Black"; print $0}' > ${study_dir}/.${study}_demos.csv
fi
